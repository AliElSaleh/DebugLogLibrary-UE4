...
DECLARE_LOG_CATEGORY_EXTERN(LogFColor, Display, All)
DECLARE_LOG_CATEGORY_EXTERN(LogCapsule, Warning, All)
DECLARE_LOG_CATEGORY_EXTERN(LogBox, Warning, All)
DECLARE_LOG_CATEGORY_EXTERN(LogSphere, Warning, All)
...
DECLARE_LOG_CATEGORY_EXTERN(LogDateTime, Display, All)
DECLARE_LOG_CATEGORY_EXTERN(LogEnum, Display, All)
DECLARE_LOG_CATEGORY_EXTERN(LogArray, Display, All)
